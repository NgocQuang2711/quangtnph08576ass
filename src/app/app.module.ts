...
@NgModule({
  ...
  declarations: [ AppComponent, HelloComponent, HomeComponent, ManageComponent, ManageAddComponent, ManageListComponent, ManageEditComponent, ManageDetailComponent ],
